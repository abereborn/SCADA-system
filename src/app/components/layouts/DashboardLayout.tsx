...
export function DashboardLayout() {
  ...
  const adminItems = [
    { name: "Master Admin", to: "/dashboard/admin", icon: <ShieldAlert className="w-5 h-5" /> },
  ];
      ...
      >
        <div className="flex items-center justify-between p-4 h-16 border-b border-border">
          ...
          <button 
            ...
            className="p-1.5 rounded-md hover:bg-accent hover:text-accent-foreground absolute -right-4 top-5 bg-card border border-border hidden md:flex"
          >
        ...
        <div className="p-3 border-t border-border mt-auto sticky bottom-0 bg-card">
          <button 
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors text-foreground/80 hover:bg-accent hover:text-accent-foreground mb-1"
          ...
          <button 
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors text-foreground/80 hover:bg-accent hover:text-accent-foreground"
            ...
            <DropdownMenu.Root>
                ...
                <button className="flex items-center gap-2 outline-none">
                  <Avatar.Root className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-primary/20">
                    <Avatar.Image
                      ...
                      alt="User avatar"
                    />
                    <Avatar.Fallback className="w-full h-full flex items-center justify-center bg-primary text-primary-foreground font-medium rounded-full">
                      AD
                    </Avatar.Fallback>
                  </Avatar.Root>
                </button>
              ...
              <DropdownMenu.Portal>
                <DropdownMenu.Content 
                  className="min-w-[200px] bg-popover text-popover-foreground rounded-md p-1 shadow-md border border-border z-50 animate-in fade-in zoom-in-95" 
                  sideOffset={5}
                  align="end"
                >
                  ...
                  <DropdownMenu.Item className="flex items-center gap-2 px-3 py-2 text-sm rounded-sm cursor-pointer hover:bg-accent hover:text-accent-foreground outline-none">
                    Edit Profile
                  </DropdownMenu.Item>
                  <DropdownMenu.Item className="flex items-center gap-2 px-3 py-2 text-sm rounded-sm cursor-pointer hover:bg-accent hover:text-accent-foreground outline-none">
                    Change Password
                  ...
                  <DropdownMenu.Item 
                    onClick={handleLogout}
                    className="flex items-center gap-2 px-3 py-2 text-sm rounded-sm cursor-pointer text-destructive hover:bg-destructive/10 outline-none font-medium"
                  >
                    Logout
                  </DropdownMenu.Item>
                </DropdownMenu.Content>
