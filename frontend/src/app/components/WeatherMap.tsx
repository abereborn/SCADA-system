...
const mockRegions = [
  ...
  { id: 8, name: "Denpasar", lat: -8.6500, lng: 115.2167, temp: 31, rainfall: 0, humidity: 75, condition: "Clear" },
...
export function WeatherMap() {
  ...
  return (
    <div className="relative w-full h-[600px] rounded-xl overflow-hidden border border-border shadow-lg z-0 bg-card">
      <MapContainer 
              ...
              <Popup className="custom-popup">
                <div className="p-1 min-w-[150px]">
                  ...
                  <div className="space-y-1 text-sm text-gray-600">
                    <p className="flex justify-between"><span>Rainfall:</span> <span className="font-medium">{region.rainfall.toFixed(1)} mm</span></p>
                    <p className="flex justify-between"><span>Temperature:</span> <span className="font-medium">{region.temp.toFixed(1)} °C</span></p>
                    <p className="flex justify-between"><span>Humidity:</span> <span className="font-medium">{region.humidity}%</span></p>
